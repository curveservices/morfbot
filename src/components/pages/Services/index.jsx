        ...
        <div className="services-page">
            <section className="hero">
                <div className="textbox">
                    <h1>Our Services</h1>
                    <p>At Morfbot, we understand that navigating the complexities of the modern business landscape requires innovative solutions and a personalised approach. Our suite of AI-powered tools and services are designed to empower your business, streamline operations, and unlock new growth opportunities. Whether you’re looking to optimise your processes, enhance customer engagement, or drive data-driven decision-making, Morfbot is here to support you every step of the way.</p>
                    <p>Our Ai approach is to enhance business workflow and develop teams and a brighter working environment. At no point are our solutions developed to encourage retrenchment, only the mundane daily or outsourced tasks can be effected. We guarantee our systems will save time and money while increasing productivity with a heavy focus on customer/client and team working experience.</p>
            ...
            <section className="second">
                <div className="textbox">
                    ...
                    <p>Firstly step is to set up a consultation, If you decide to work with us, 50% of the consultation fee will be deducted from your first month retainer. Our Ai systems are created, implemented and maintained by Morfbot Ai Business Solutions, Please see below a short list of services provided.</p>
                    <ul>
